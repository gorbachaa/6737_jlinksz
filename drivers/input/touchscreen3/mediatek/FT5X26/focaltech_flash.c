...
//#include <mt-plat/neostra_tp_update.h>
...
extern void neostra_tp_update_disable_pwrkey(int update);
/*******************************************************************************
...
static unsigned char CTPM_FW[] = 
{
	...
	//#include "Acer_A10L2_PingBo_FT5826S_V18_D04_20170515_app.i" //Neostra liudongke update TP firmware for wakeup effective optimization and avoiding large area wakeup
	#include "Acer_A10L2_PingBo_FT5826S_V80_D04_20170606_app.i" //Neostra liudongke update pingbo TP firmware to modify firmware version to 0x80
};
...
static unsigned char TAIGUAN_FW[] = 
{
    ...
    //  #include "Acer_A10L2_TaiGuan_FT5826S_V52_D04_20170414_app.i"    //Neostra liudongke modify for TP gesture 20170117
    #include "Acer_A10L2_TaiGuan_FT5826S_V55_D04_20170505_app.i" //Neostra liudongke modify for esd 20170505
	};
...
int fts_ctpm_get_i_file_ver(void)
{
	...
	if(vendor_tp_id==0x7b)
	{
		...
		TPD_DMESG("[FTS] hxh tp_vendor_id==0x%x\n",uc_host_fm_ver);	
		
	}
	else if((vendor_tp_id==0x3e))//Neostra huangxiaohui add for taiguan new vendorID:0x3E
	{
...
int fts_ctpm_auto_upgrade(struct i2c_client *client)
{
	...
	int i_ret=-1; // Neostra huangxiaohui mod  20160726

	fts_read_reg(client, FTS_REG_FW_VER, &uc_tp_fm_ver);
	fts_read_reg(client, FTS_REG_VENDOR_ID, &uc_tp_vendor_id);
	vendor_tp_id=uc_tp_vendor_id;  // Neostra huangxiaohui mod  20160726
	...
	{
	   neostra_tp_update_disable_pwrkey(1);//Add Neostra taosong for:disable long press powerkey operation,when TP FW update. 20170329
		msleep(100);
		...
		else if((uc_tp_vendor_id==0x3e))//Neostra huangxiaohui add for taiguan new vendorID:0x3E  20161013
		{
		...
		neostra_tp_update_disable_pwrkey(0);//Add Neostra taosong for:enable long press powerkey operation,when TP FW update finish. 20170329
	}
#endif	
	return 0;
}
